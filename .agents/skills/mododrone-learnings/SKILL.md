...
- **2026-08-06**:
  ...
  - **Rediseño de Botón Contacto en Navbar**: Reemplazo de la opción de texto "Contacto" en el menú de navegación por un botón destacado redondeado (`rounded-full`) con fondo oscuro (`bg-black/60`), borde verde neón (`border-apple-green`), texto verde (`text-apple-green`) y efecto hover con resplandor neón.
