...
- **2026-08-05**:
  - **Simplificación & Limpieza del Carrusel de Reels**: Remoción total de iFrames embebidos en las tarjetas del carrusel, reproductores ocultos y escuchas de eventos/timers. Las tarjetas se renderizan únicamente con la miniatura estática en formato vertical `9:16`, con ícono de reproducción en hover, badge de categoría y el título ubicado en la parte inferior por debajo de la miniatura. Al hacer clic en cualquier tarjeta, se despliega el modal pop-up adaptativo con la reproducción del video.
