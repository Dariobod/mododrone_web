...
- **2026-08-06**:
  ...
  - **Botonera Directa en Portfolio & Academia**: Adición del botón CTA "Ver en YouTube" (`fa-brands fa-youtube text-red-500`) en la cabecera de Portfolio Paisajes (`https://www.youtube.com/@ModoDrone/videos`) y actualización del botón en Academia & Tutoriales a "Ver Shorts" enlazando a `https://www.youtube.com/@ModoDrone/shorts`.
  - **Rediseño de Botón Contacto en Navbar**: Reemplazo de la opción de texto "Contacto" en el menú de navegación por un botón destacado redondeado (`rounded-full`) con fondo transparente (`bg-transparent`), borde verde neón (`border-apple-green`), texto verde (`text-apple-green`) y efecto hover con relleno neón y resplandor.
