...
- **2026-08-01**:
  ...
  - **Prueba de UI - Previsualización de Video en Vivo en Reels**: Configuración de reproducción automática (autoplay, muted, loop) de los videos directamente en las tarjetas de la sección Reels sin zoom (`scale-125` removido) y sin superposición del icono de play al hacer hover (`play-overlay` removido para vista directa limpia del video).
