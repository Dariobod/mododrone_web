...
- **2026-08-06**:
  ...
  - **Botonera Directa en Portfolio**: Adición del botón CTA "Ver en YouTube" (`fa-brands fa-youtube text-red-500`) en la cabecera de la sección Portfolio Paisajes enlazando a `https://www.youtube.com/@ModoDrone/videos`.
