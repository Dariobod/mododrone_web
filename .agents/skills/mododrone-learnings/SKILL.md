...
- **2026-08-06**:
  - **Hover Preview estilo YouTube en Portfolio & Academia**: Implementación de inyección dinámica de vista previa de video al hacer hover (`onmouseenter`) en las tarjetas de las secciones Portfolio Paisajes y Academia/Tutoriales (`renderGrid`), con remoción limpia e inmediata del iFrame al retirar el cursor (`onmouseleave`). Carga estática ultrarrápida inicial (0ms).
