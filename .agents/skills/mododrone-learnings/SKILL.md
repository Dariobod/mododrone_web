...
- **2026-08-05**:
  - **Simplificación & Limpieza del Carrusel de Reels**: Remoción total de iFrames embebidos en las tarjetas del carrusel, reproductores ocultos y escuchas de eventos/timers. Cada tarjeta en el carrusel de Reels es exclusivamente la miniatura estática en formato vertical `9:16` (sin contenedores de texto inferiores) con superposición elegante de título, badge de categoría e ícono interactivo de reproducción. Al hacer clic en cualquier tarjeta, se despliega el modal pop-up adaptativo reproduciendo el video original.
