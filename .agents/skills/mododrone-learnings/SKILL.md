...
- **2026-08-06**:
  ...
  - **Volumen al 50% en Reproductor de Modal (Reels & Shorts / Videos)**: Configuración del reproductor emergente en `openModal` mediante `enablejsapi=1` y comandos postMessage (`unMute` + `setVolume(50)`) para que los videos inicien su reproducción con sonido activo al 50% de volumen.
