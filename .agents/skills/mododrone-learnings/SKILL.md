...
- **2026-08-01**:
  ...
  - **Prueba de UI - Reproducción Directa de Videos en Reels**: Restauración de la carga directa e inmediata del reproductor de video en vivo (autoplay, muted, loop) en las tarjetas del carrusel de Reels sin paso estático previo.
