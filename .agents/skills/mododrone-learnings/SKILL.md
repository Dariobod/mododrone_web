...
- **2026-08-01**:
  ...
  - **Prueba de UI - Reproducción Directa de Videos en Reels**: Restauración de la carga directa e inmediata del reproductor de video en vivo (autoplay, muted, loop) en las tarjetas del carrusel de Reels sin paso estático previo y con supresión de controles e íconos nativos de YouTube (`controls=0`, `disablekb=1`, `iv_load_policy=3`, `scale-[1.08]`).
